    ...
    html: `<div style="background:#f1f5f9;padding:28px 12px;font-family:Arial,Helvetica,sans-serif;color:#334155">
      <div style="max-width:680px;margin:auto;overflow:hidden;border:1px solid #e2e8f0;border-radius:18px;background:#ffffff">
        ...
        <div style="padding:26px 28px"><p style="margin:0 0 18px;font-size:15px;line-height:1.7">Hello <strong>${escapeHtml(recipientName)}</strong>,</p>
          ...
          ${approved ? '' : '<div style="margin:18px 0;padding:15px;border:1px solid #fecaca;border-radius:12px;background:#fef2f2;color:#991b1b;font-size:14px;line-height:1.7"><strong>Action required within 48 working hours.</strong> One reminder will be sent after 24 working hours. If approval is not obtained within 48 working hours, the Client Master will receive a red flag. A final 24-working-hour recovery window will then remain available to correct the data and obtain compliance approval so the flag can return to green. After 72 working hours, the red flag becomes permanent. First and third Saturdays are office holidays and do not count; each such Saturday extends the deadline by 24 hours.</div>'}
