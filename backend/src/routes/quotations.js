...
router.get('/management-approvers', requireAuth, quotationCtrl.listManagementApprovers);
...
router.patch('/:id/management-approval', requireAuth, quotationCtrl.submitManagementApproval);
