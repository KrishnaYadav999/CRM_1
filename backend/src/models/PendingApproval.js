...
const PendingApprovalSchema = new mongoose.Schema({
  type: { type: String, enum: ['client', 'quotation', 'lead_duplicate', 'lead_royalty', 'lead_service'], default: 'client', index: true },
  ...
  reminderFlag: { type: String, enum: ['', 'GREEN', 'RED'], default: '', index: true },
  redFlagAt: { type: Date },
