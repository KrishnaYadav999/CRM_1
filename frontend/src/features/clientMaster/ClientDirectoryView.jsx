  ...
  function exportExcel() {
    const rows = filteredClients.map((item) => {
      ...
      return {
        ...
        'Factory License Applicability': data.compliance?.factoryLicenseApplicability || (String(data.basic?.piboCategory || '').toLowerCase().includes('brand owner') ? 'Not Applicable' : 'Auto'),
        'Factory License Applicability Reason': data.compliance?.factoryLicenseApplicabilityReason || '',
