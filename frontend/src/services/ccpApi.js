...
function normalizeCcpLead(row = {}) {
  ...
  return {
    ...
    applicantType: firstFilled(row.applicantType, row.serviceSelections?.[0]?.applicantType),
    serviceSelections: Array.isArray(row.serviceSelections) ? row.serviceSelections : [],
    servicesOffered: firstFilled(row.servicesOffered, row.service, row.services, basic.servicesOffered),
    firstAnnualReturnYearApplicable: firstFilled(row.firstAnnualReturnYearApplicable, row.serviceSelections?.[0]?.firstAnnualReturnYearApplicable),
