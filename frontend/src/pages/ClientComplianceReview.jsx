...
import { AlertTriangle, ArrowLeft, Building2, Camera, CheckCircle2, ChevronRight, ExternalLink, FileCheck2, FileText, Image as ImageIcon, KeyRound, Loader2, MapPin, RotateCcw, Save, Scale, Settings, ShieldCheck, UserRound, XCircle } from 'lucide-react'
...
export default function ClientComplianceReview() {
  ...
  if (loading) return <DashboardShell currentUser={currentUser} hideSidebar><div className="grid min-h-screen place-items-center bg-slate-50"><Loader2 className="h-10 w-10 animate-spin text-emerald-700" /></div></DashboardShell>
  return <DashboardShell currentUser={currentUser} hideSidebar><div className="min-h-screen bg-[#f3f8f6] p-2 lg:p-3"><div className="w-full max-w-none space-y-4">
