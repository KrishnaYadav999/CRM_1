...
export default function SupportTickets() {
  ...
  async function updateTicket(payload) {
    ...
    try {
      ...
      setTickets((items) => items.map((item) => String(item._id) === String(data.ticket._id) ? data.ticket : item)); setSelected(data.ticket); setReply(''); setPendingStatus(''); setStatusNote('')
