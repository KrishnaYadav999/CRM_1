...
export default function LeadAllocate() {
  ...
  const load = async (quiet = false) => {
    ...
    try {
      ...
      setAdmins(users.filter((user) => user.isActive !== false && ['admin', 'superadmin'].includes(String(user.role || '').toLowerCase())))
    } catch (error) {
